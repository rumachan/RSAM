...
#WIZ.10-HHZ.NZ
#last month
rsam_plot.py WIZ.10-HHZ.NZ ./workdir $monthdate $date ./workdir/my_rsam bp 2 5
\mv ./workdir/my_rsam/rsam_plot.png ./output/WIZ.rsam_plot_month.bp_2.00-5.00.png

#WIZ.10-HHZ.NZ
#last week
rsam_plot.py WIZ.10-HHZ.NZ ./workdir $weekdate $date ./workdir/my_rsam bp 2 5
\mv ./workdir/my_rsam/rsam_plot.png ./output/WIZ.rsam_plot_week.bp_2.00-5.00.png

#WSRZ.10-HHZ.NZ
#last month
rsam_plot.py WSRZ.10-HHZ.NZ ./workdir $monthdate $date ./workdir/my_rsam bp 2 5
\mv ./workdir/my_rsam/rsam_plot.png ./output/WSRZ.rsam_plot2_month.bp_2.00-5.00.png

#WSRZ.10-HHZ.NZ
#last week
rsam_plot.py WSRZ.10-HHZ.NZ ./workdir $weekdate $date ./workdir/my_rsam bp 2 5
\mv ./workdir/my_rsam/rsam_plot.png ./output/WSRZ.rsam_plot2_week.bp_2.00-5.00.png

#DRZ.10-EHZ.NZ
#last month
rsam_plot.py DRZ.10-EHZ.NZ ./workdir $monthdate $date ./workdir/my_rsam bp 1 4
\mv ./workdir/my_rsam/rsam_plot.png ./output/DRZ.rsam_plot_month.bp_1.00-4.00.png

#DRZ.10-EHZ.NZ
#last week
rsam_plot.py DRZ.10-EHZ.NZ ./workdir $weekdate $date ./workdir/my_rsam bp 1 4
\mv ./workdir/my_rsam/rsam_plot.png ./output/DRZ.rsam_plot_week.bp_1.00-4.00.png

#MAVZ.10-HHZ.NZ
#last month
rsam_plot.py MAVZ.10-HHZ.NZ ./workdir $monthdate $date ./workdir/my_rsam bp 1 4
\mv ./workdir/my_rsam/rsam_plot.png ./output/MAVZ.rsam_plot2_month.bp_1.00-4.00.png

#MAVZ.10-HHZ.NZ
#last week
rsam_plot.py MAVZ.10-HHZ.NZ ./workdir $weekdate $date ./workdir/my_rsam bp 1 4
\mv ./workdir/my_rsam/rsam_plot.png ./output/MAVZ.rsam_plot2_week.bp_1.00-4.00.png

#RAR.10-BHZ.IU
#last month
rsam_plot.py RAR.10-BHZ.IU ./workdir $monthdate $date ./workdir/my_rsam bp 1.5 6
